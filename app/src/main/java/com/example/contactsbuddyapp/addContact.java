...
public class addContact extends AppCompatActivity {
    ...
    private String contactName, contactNumber, email;
    ...
    private void addCameraImage() {
        ...
        contactImage = getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);

        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, contactImage);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            if (ContextCompat.checkSelfPermission(addContact.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED &&
                                    ContextCompat.checkSelfPermission(addContact.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                            ...
                            if (ContextCompat.checkSelfPermission(addContact.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
    ...
    private void save() {
        ...
        Toast.makeText(this, "" + contactName + " has been saved successfully!", Toast.LENGTH_LONG).show();;
        onBackPressed();
    }
    ...
    private void saveImageToDirectory(String srcDir, String desDir) throws IOException {
        ...
        try {
            ...
            contactImage = Uri.parse(des.getPath());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == IMAGE_PICK_GALLERY_CODE) {
                ...
                CropImage.activity(contactImage)
                        .setGuidelines(CropImageView.Guidelines.ON)
                        .setAspectRatio(1, 1)
                        .start(this);
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    contactImage = resultUri;
                    IV_addPhoto.setImageURI(resultUri);

                    try {
                        saveImageToDirectory("" + contactImage.getPath(), "" + getDir("contacts_images", MODE_PRIVATE));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
